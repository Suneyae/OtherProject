<%@ page language="java" import="com.bjsxt.shopping.user.*"
	pageEncoding="UTF-8"%>
...
<%
	...
	System.out.print("Register.jsp, action:" + action);
...
<script type="text/javascript">
	...
	function setMsg(msg) {
		...
		if (msg == "invalid") {
			mdiv.innerHTML = "用户名:<font color='red'>"+Gname+" 已经存在，不能注册</font>";
		} else {
...
<form method="post" name="register" action="Register.jsp"
	...
	<input type="hidden" name="action" value="register2222" />
...
<table class="smalltxt" cellpadding="4" cellspacing="0" width="100%">
	<tbody>
		<tr class="altbg1">
			<td>所有时间为 GMT+8, 现在时间是 2007-4-20 11:17</td>
			<td align="right"><a
